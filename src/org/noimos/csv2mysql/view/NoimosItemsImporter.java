 ...
 */
public class NoimosItemsImporter extends javax.swing.JFrame {

    File file = null;
    int count = 0;
    String separator = ",";

    public NoimosItemsImporter() {
        initComponents();
...
//                        String query = getCategoryQuery(index, line);
                        String query = getItemQuery(index, line);
                        try {
                            if (query != null) {
                                int id = MySQLDatabase.setData(connection, statement, query);
                                MySQLDatabase.setData(connection, statement, getProductQuery(index, line));
                            }
                            connection.commit();
                            estIndex++;
    ...
    private String getCategoryQuery(int index, String line) {
